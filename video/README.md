...
## 出典が未確認のおみくじ
写真で確認済: 金劔宮・白山比咩神社(2枚)・服部神社・那谷寺。
**仕様書のテキストのみ**（実写真未受領・要照合）なのは、DAY2の
**菟橋神社**と**安宅住吉神社**のおみくじ本文です。
`omikuji_transcriptions.md` の ⚠️ 印を撮影原本と照合してから確定してください。
※「うはし神社」の正式表記は **菟橋神社（読み: うはし）** で確認済み。
